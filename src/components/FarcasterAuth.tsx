  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        type="button"
        className="flex items-center gap-3 bg-gradient-to-r from-[#8a63d2] to-[#6a4bb5] hover:from-[#9b74e3] hover:to-[#7b5cc6] px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 hover:scale-105 border border-purple-400/30 cursor-pointer active:scale-95"
      >
        <svg width="20" height="20" viewBox="0 0 1000 1000" fill="none" xmlns="http://www.w3.org/2000/svg" className="pointer-events-none">
        ...
        <span className="pointer-events-none">Sign In with Farcaster</span>
      </button>
